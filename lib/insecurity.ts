...
// 20260608 delete export const isAuthorized = () => expressJwt(({ secret: publicKey }) as any)
// 20260608 Updated isAuthorized implementation
...
// 20260608 delete export const authorize = (user = {}) => jwt.sign(user, privateKey, { expiresIn: '6h', algorithm: 'RS256' })
// 20260608 Add issuer, audience claims to our JWT creation
