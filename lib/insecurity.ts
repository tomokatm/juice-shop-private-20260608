...
// 20260608 export const isAuthorized = () => expressJwt(({ secret: publicKey }) as any)
...
// 20260608 export const authorize = (user = {}) => jwt.sign(user, privateKey, { expiresIn: '6h', algorithm: 'RS256' })
